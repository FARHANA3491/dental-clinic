<?php include('connect.php');
   ...
   if(isset($_POST['submit'])){
	...
	$sql = "INSERT into `appointment` (pa_id,treatment, d_name, ap_time,ap_date)
	values('$pa_id','$dept','$doc','$ap_time','$ap_date')";
...
<legend> BOOK APPOINTMENT</legend>
		...
		<select  id="category2" name="category2" class="fill" onchange="location =userpro.php;">
...
<input type="submit" value="Confirm the Appointment" name="submit">
</form>
</div>
